...
#include "dro_hg/msg/detail/low_state__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const dro_hg::msg::LowState & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  dro_hg::msg::LowState & ros_message)
{
  // Member: header
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = dro_hg::msg::LowState;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const dro_hg::msg::LowState *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<dro_hg::msg::LowState *>(
    untyped_ros_message);
...
{
  return &dro_hg::msg::typesupport_fastrtps_cpp::_LowState__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, dro_hg, msg, LowState)() {
  return &dro_hg::msg::typesupport_fastrtps_cpp::_LowState__handle;
}
