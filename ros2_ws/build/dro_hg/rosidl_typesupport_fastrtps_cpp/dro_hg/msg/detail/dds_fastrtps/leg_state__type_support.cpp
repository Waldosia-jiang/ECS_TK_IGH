...
#include "dro_hg/msg/detail/leg_state__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const dro_hg::msg::LegState & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  dro_hg::msg::LegState & ros_message)
{
  // Member: header
  ...
  size_t current_alignment)
{
  ...
  // Member: motor_state
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        dro_hg::msg::typesupport_fastrtps_cpp::max_serialized_size_MotorState(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    using DataType = dro_hg::msg::LegState;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const dro_hg::msg::LegState *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<dro_hg::msg::LegState *>(
    untyped_ros_message);
...
static size_t _LegState__max_serialized_size(char & bounds_info)
{
  bool full_bounded;
  bool is_plain;
  size_t ret_val;

  ret_val = max_serialized_size_LegState(full_bounded, is_plain, 0);
...
{
  return &dro_hg::msg::typesupport_fastrtps_cpp::_LegState__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, dro_hg, msg, LegState)() {
  return &dro_hg::msg::typesupport_fastrtps_cpp::_LegState__handle;
}
