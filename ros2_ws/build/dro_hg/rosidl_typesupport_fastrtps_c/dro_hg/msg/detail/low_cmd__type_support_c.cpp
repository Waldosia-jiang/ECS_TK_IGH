...
#include "dro_hg/msg/detail/low_cmd__rosidl_typesupport_fastrtps_c.h"
...
using _LowCmd__ros_msg_type = dro_hg__msg__LowCmd;
...
size_t get_serialized_size_dro_hg__msg__LowCmd(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _LowCmd__ros_msg_type * ros_message = static_cast<const _LowCmd__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _LowCmd__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_dro_hg__msg__LowCmd(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_dro_hg
size_t max_serialized_size_dro_hg__msg__LowCmd(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = dro_hg__msg__LowCmd;
    is_plain =
      (
...
static size_t _LowCmd__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_dro_hg__msg__LowCmd(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, dro_hg, msg, LowCmd)() {
