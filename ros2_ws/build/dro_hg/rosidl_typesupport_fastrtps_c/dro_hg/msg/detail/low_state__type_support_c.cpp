...
#include "dro_hg/msg/detail/low_state__rosidl_typesupport_fastrtps_c.h"
...
using _LowState__ros_msg_type = dro_hg__msg__LowState;
...
size_t get_serialized_size_dro_hg__msg__LowState(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _LowState__ros_msg_type * ros_message = static_cast<const _LowState__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _LowState__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_dro_hg__msg__LowState(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_dro_hg
size_t max_serialized_size_dro_hg__msg__LowState(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = dro_hg__msg__LowState;
    is_plain =
      (
...
static size_t _LowState__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_dro_hg__msg__LowState(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, dro_hg, msg, LowState)() {
