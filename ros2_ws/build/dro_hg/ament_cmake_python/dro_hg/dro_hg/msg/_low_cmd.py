...
class LowCmd(metaclass=Metaclass_LowCmd):
    ...
    _fields_and_field_types = {
        ...
        'begin': 'uint8',
        'end': 'uint8',
        'motor_cmd': 'sequence<dro_hg/MotorCmd, 29>',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.BasicType('uint8'),  # noqa: E501
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['dro_hg', 'msg'], 'MotorCmd'), 29),  # noqa: E501
    )
        ...
        if __debug__:
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 True), \
                "The 'motor_cmd' field must be a set or sequence with length <= 29 and each value of type 'MotorCmd'"
