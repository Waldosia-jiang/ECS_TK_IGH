...
#ifndef ARM_CONTROL__MSG__DETAIL__MOTOR_CMD__TRAITS_HPP_
#define ARM_CONTROL__MSG__DETAIL__MOTOR_CMD__TRAITS_HPP_
...
inline void to_yaml(
  const arm_control::msg::MotorCmd & msg,
  std::ostream & out, size_t indentation = 0)
{
...
inline std::string to_yaml(const arm_control::msg::MotorCmd & msg)
{
  return arm_control::msg::to_yaml(msg);
}

template<>
inline const char * data_type<arm_control::msg::MotorCmd>()
{
  return "arm_control::msg::MotorCmd";
}

template<>
inline const char * name<arm_control::msg::MotorCmd>()
{
  return "arm_control/msg/MotorCmd";
}

template<>
struct has_fixed_size<arm_control::msg::MotorCmd>
  : std::integral_constant<bool, true> {};

template<>
struct has_bounded_size<arm_control::msg::MotorCmd>
  : std::integral_constant<bool, true> {};

template<>
struct is_message<arm_control::msg::MotorCmd>
  : std::true_type {};

}  // namespace rosidl_generator_traits

#endif  // ARM_CONTROL__MSG__DETAIL__MOTOR_CMD__TRAITS_HPP_
