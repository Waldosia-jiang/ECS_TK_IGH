...
class Metaclass_LowState(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from arm_control.msg import MotorState
...
class LowState(metaclass=Metaclass_LowState):
    ...
    _fields_and_field_types = {
        ...
        'slave_num': 'uint8',
        'motor_state': 'sequence<arm_control/MotorState, 14>',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.NamespacedType(['std_msgs', 'msg'], 'Header'),  # noqa: E501
        rosidl_parser.definition.BasicType('uint8'),  # noqa: E501
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['arm_control', 'msg'], 'MotorState'), 14),  # noqa: E501
    )
    ...
    def __init__(self, **kwargs):
        ...
        self.slave_num = kwargs.get('slave_num', int())
    ...
    def __eq__(self, other):
        ...
        if self.header != other.header:
            return False
        if self.slave_num != other.slave_num:
            return False
    ...
    @builtins.property
    def slave_num(self):
        """Message field 'slave_num'."""
        return self._slave_num

    @slave_num.setter
    def slave_num(self, value):
        if __debug__:
            assert \
                isinstance(value, int), \
                "The 'slave_num' field must be of type 'int'"
            assert value >= 0 and value < 256, \
                "The 'slave_num' field must be an unsigned integer in [0, 255]"
        self._slave_num = value
        ...
        if __debug__:
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 True), \
                "The 'motor_state' field must be a set or sequence with length <= 14 and each value of type 'MotorState'"
