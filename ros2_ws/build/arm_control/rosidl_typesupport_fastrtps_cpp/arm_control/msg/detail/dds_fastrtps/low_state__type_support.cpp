...
#include "arm_control/msg/detail/low_state__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
bool cdr_serialize(
  const arm_control::msg::MotorState &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
  arm_control::msg::MotorState &);
size_t get_serialized_size(
  const arm_control::msg::MotorState &,
  size_t current_alignment);
size_t
...
cdr_serialize(
  const arm_control::msg::LowState & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  arm_control::msg::LowState & ros_message)
{
  // Member: header
  ...
  size_t current_alignment)
{
  ...
  // Member: motor_state
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        arm_control::msg::typesupport_fastrtps_cpp::max_serialized_size_MotorState(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    using DataType = arm_control::msg::LowState;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const arm_control::msg::LowState *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<arm_control::msg::LowState *>(
    untyped_ros_message);
...
{
  return &arm_control::msg::typesupport_fastrtps_cpp::_LowState__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, arm_control, msg, LowState)() {
  return &arm_control::msg::typesupport_fastrtps_cpp::_LowState__handle;
}
