...
#include "arm_control/msg/detail/low_cmd__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
bool cdr_serialize(
  const arm_control::msg::MotorCmd &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
  arm_control::msg::MotorCmd &);
size_t get_serialized_size(
  const arm_control::msg::MotorCmd &,
  size_t current_alignment);
size_t
...
cdr_serialize(
  const arm_control::msg::LowCmd & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Member: motor_cmd
  {
    ...
    for (size_t i = 0; i < size; i++) {
      arm_control::msg::typesupport_fastrtps_cpp::cdr_serialize(
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  arm_control::msg::LowCmd & ros_message)
{
  // Member: header
  ...
  // Member: motor_cmd
  {
    ...
    for (size_t i = 0; i < size; i++) {
      arm_control::msg::typesupport_fastrtps_cpp::cdr_deserialize(
  ...
  size_t current_alignment)
{
  ...
  // Member: motor_cmd
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        arm_control::msg::typesupport_fastrtps_cpp::get_serialized_size(
  ...
  size_t current_alignment)
{
  ...
  // Member: motor_cmd
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        arm_control::msg::typesupport_fastrtps_cpp::max_serialized_size_MotorCmd(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    using DataType = arm_control::msg::LowCmd;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const arm_control::msg::LowCmd *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<arm_control::msg::LowCmd *>(
    untyped_ros_message);
...
{
  return &arm_control::msg::typesupport_fastrtps_cpp::_LowCmd__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, arm_control, msg, LowCmd)() {
  return &arm_control::msg::typesupport_fastrtps_cpp::_LowCmd__handle;
}
