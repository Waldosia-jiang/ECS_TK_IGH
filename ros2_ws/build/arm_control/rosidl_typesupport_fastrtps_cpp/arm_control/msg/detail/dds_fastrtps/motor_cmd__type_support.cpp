...
#include "arm_control/msg/detail/motor_cmd__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const arm_control::msg::MotorCmd & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  arm_control::msg::MotorCmd & ros_message)
{
  // Member: mode
  cdr >> ros_message.mode;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = arm_control::msg::MotorCmd;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const arm_control::msg::MotorCmd *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<arm_control::msg::MotorCmd *>(
    untyped_ros_message);
...
{
  return &arm_control::msg::typesupport_fastrtps_cpp::_MotorCmd__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, arm_control, msg, MotorCmd)() {
  return &arm_control::msg::typesupport_fastrtps_cpp::_MotorCmd__handle;
}
