...
#include "arm_control/msg/detail/low_state__rosidl_typesupport_fastrtps_c.h"
...
#include "arm_control/msg/detail/motor_state__functions.h"  // motor_state
#include "std_msgs/msg/detail/header__functions.h"  // header

// forward declare type support functions
size_t get_serialized_size_arm_control__msg__MotorState(
  const void * untyped_ros_message,
  size_t current_alignment);

size_t max_serialized_size_arm_control__msg__MotorState(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment);

const rosidl_message_type_support_t *
  ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, arm_control, msg, MotorState)();
ROSIDL_TYPESUPPORT_FASTRTPS_C_IMPORT_arm_control
...
using _LowState__ros_msg_type = arm_control__msg__LowState;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: motor_state
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, arm_control, msg, MotorState
      )()->data);
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: motor_state
  {
    ...
    if (ros_message->motor_state.data) {
      arm_control__msg__MotorState__Sequence__fini(&ros_message->motor_state);
    }
    if (!arm_control__msg__MotorState__Sequence__init(&ros_message->motor_state, size)) {
...
size_t get_serialized_size_arm_control__msg__LowState(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _LowState__ros_msg_type * ros_message = static_cast<const _LowState__ros_msg_type *>(untyped_ros_message);
  ...
  // field.name motor_state
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += get_serialized_size_arm_control__msg__MotorState(
...
static uint32_t _LowState__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_arm_control__msg__LowState(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_arm_control
size_t max_serialized_size_arm_control__msg__LowState(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // member: motor_state
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_arm_control__msg__MotorState(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    using DataType = arm_control__msg__LowState;
    is_plain =
      (
...
static size_t _LowState__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_arm_control__msg__LowState(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, arm_control, msg, LowState)() {
