...
class Metaclass_LowCmd(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from arm_control.msg import MotorCmd
...
class LowCmd(metaclass=Metaclass_LowCmd):
    ...
    _fields_and_field_types = {
        ...
        'begin': 'uint8',
        'end': 'uint8',
        'motor_cmd': 'sequence<arm_control/MotorCmd, 14>',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.BasicType('uint8'),  # noqa: E501
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['arm_control', 'msg'], 'MotorCmd'), 14),  # noqa: E501
    )
        ...
        if __debug__:
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 True), \
                "The 'motor_cmd' field must be a set or sequence with length <= 14 and each value of type 'MotorCmd'"
