...
#ifndef DRO_HG__MSG__DETAIL__LOW_CMD__TRAITS_HPP_
#define DRO_HG__MSG__DETAIL__LOW_CMD__TRAITS_HPP_
...
inline std::string to_yaml(const dro_hg::msg::LowCmd & msg)
{
  return dro_hg::msg::to_yaml(msg);
}

template<>
inline const char * data_type<dro_hg::msg::LowCmd>()
{
  return "dro_hg::msg::LowCmd";
}

template<>
inline const char * name<dro_hg::msg::LowCmd>()
{
  return "dro_hg/msg/LowCmd";
}

template<>
struct has_fixed_size<dro_hg::msg::LowCmd>
  : std::integral_constant<bool, false> {};

template<>
struct has_bounded_size<dro_hg::msg::LowCmd>
  : std::integral_constant<bool, has_bounded_size<dro_hg::msg::MotorCmd>::value && has_bounded_size<std_msgs::msg::Header>::value> {};

template<>
struct is_message<dro_hg::msg::LowCmd>
  : std::true_type {};

}  // namespace rosidl_generator_traits

#endif  // DRO_HG__MSG__DETAIL__LOW_CMD__TRAITS_HPP_
