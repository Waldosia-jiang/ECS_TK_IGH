...
{
  new (message_memory) dro_hg::msg::LowCmd(_init);
}

void LowCmd_fini_function(void * message_memory)
{
  auto typed_message = static_cast<dro_hg::msg::LowCmd *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember LowCmd_message_member_array[4] = {
  {
    ...
    offsetof(dro_hg::msg::LowCmd, header),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(dro_hg::msg::LowCmd, begin),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(dro_hg::msg::LowCmd, end),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    29,  // array size
    true,  // is upper bound
    offsetof(dro_hg::msg::LowCmd, motor_cmd),  // bytes offset in struct
    nullptr,  // default value
...
{
  return &::dro_hg::msg::rosidl_typesupport_introspection_cpp::LowCmd_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, dro_hg, msg, LowCmd)() {
  return &::dro_hg::msg::rosidl_typesupport_introspection_cpp::LowCmd_message_type_support_handle;
}
