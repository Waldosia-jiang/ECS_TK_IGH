...
{
  new (message_memory) arm_control::msg::LowCmd(_init);
}

void LowCmd_fini_function(void * message_memory)
{
  auto typed_message = static_cast<arm_control::msg::LowCmd *>(message_memory);
  typed_message->~LowCmd();
}

size_t size_function__LowCmd__motor_cmd(const void * untyped_member)
{
  const auto * member = reinterpret_cast<const std::vector<arm_control::msg::MotorCmd> *>(untyped_member);
  return member->size();
}
...
{
  const auto & member =
    *reinterpret_cast<const std::vector<arm_control::msg::MotorCmd> *>(untyped_member);
  return &member[index];
}
...
{
  auto & member =
    *reinterpret_cast<std::vector<arm_control::msg::MotorCmd> *>(untyped_member);
  return &member[index];
}
...
{
  const auto & item = *reinterpret_cast<const arm_control::msg::MotorCmd *>(
    get_const_function__LowCmd__motor_cmd(untyped_member, index));
  auto & value = *reinterpret_cast<arm_control::msg::MotorCmd *>(untyped_value);
  value = item;
}
...
{
  auto & item = *reinterpret_cast<arm_control::msg::MotorCmd *>(
    get_function__LowCmd__motor_cmd(untyped_member, index));
  const auto & value = *reinterpret_cast<const arm_control::msg::MotorCmd *>(untyped_value);
  item = value;
}

void resize_function__LowCmd__motor_cmd(void * untyped_member, size_t size)
{
  auto * member =
    reinterpret_cast<std::vector<arm_control::msg::MotorCmd> *>(untyped_member);
  member->resize(size);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember LowCmd_message_member_array[4] = {
  {
    ...
    offsetof(arm_control::msg::LowCmd, header),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(arm_control::msg::LowCmd, begin),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(arm_control::msg::LowCmd, end),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    ::rosidl_typesupport_introspection_cpp::ROS_TYPE_MESSAGE,  // type
    0,  // upper bound of string
    ::rosidl_typesupport_introspection_cpp::get_message_type_support_handle<arm_control::msg::MotorCmd>(),  // members of sub message
    true,  // is array
    14,  // array size
    true,  // is upper bound
    offsetof(arm_control::msg::LowCmd, motor_cmd),  // bytes offset in struct
    nullptr,  // default value
    ...
    resize_function__LowCmd__motor_cmd  // resize(index) function pointer
  }
};
...
get_message_type_support_handle<arm_control::msg::LowCmd>()
{
  return &::arm_control::msg::rosidl_typesupport_introspection_cpp::LowCmd_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, arm_control, msg, LowCmd)() {
  return &::arm_control::msg::rosidl_typesupport_introspection_cpp::LowCmd_message_type_support_handle;
}
