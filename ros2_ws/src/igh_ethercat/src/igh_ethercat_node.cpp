...
public:
  IghEthercatNode() : Node("igh_ethercat_node") {
    ...
    state_pub_ = this->create_publisher<dro_hg::msg::ArmState>("arm_state", 10);
    cmd_sub_ = this->create_subscription<dro_hg::msg::ArmCmd>(
      "arm_cmd", 10,
...
private:
  void on_cmd(const dro_hg::msg::ArmCmd::SharedPtr msg) {
  ...
  std::mutex cmd_mtx_;
  rclcpp::Subscription<dro_hg::msg::ArmCmd>::SharedPtr cmd_sub_;
  rclcpp::Publisher<dro_hg::msg::ArmState>::SharedPtr state_pub_;
