...
static const _LegState_type_support_symbol_names_t _LegState_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, dro_hg, msg, LegState)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, dro_hg, msg, LegState)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, dro_hg, msg, LegState)() {
  return &::dro_hg::msg::rosidl_typesupport_c::LegState_message_type_support_handle;
}
