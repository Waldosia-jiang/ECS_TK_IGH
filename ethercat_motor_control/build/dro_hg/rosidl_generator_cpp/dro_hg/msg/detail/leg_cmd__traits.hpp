...
#ifndef DRO_HG__MSG__DETAIL__LEG_CMD__TRAITS_HPP_
#define DRO_HG__MSG__DETAIL__LEG_CMD__TRAITS_HPP_
...
inline std::string to_yaml(const LegCmd & msg, bool use_flow_style = false)
{
...
inline std::string to_yaml(const dro_hg::msg::LegCmd & msg)
{
  return dro_hg::msg::to_yaml(msg);
}

template<>
inline const char * data_type<dro_hg::msg::LegCmd>()
{
  return "dro_hg::msg::LegCmd";
}

template<>
inline const char * name<dro_hg::msg::LegCmd>()
{
  return "dro_hg/msg/LegCmd";
}

template<>
struct has_fixed_size<dro_hg::msg::LegCmd>
  : std::integral_constant<bool, false> {};

template<>
struct has_bounded_size<dro_hg::msg::LegCmd>
  : std::integral_constant<bool, has_bounded_size<dro_hg::msg::MotorCmd>::value && has_bounded_size<std_msgs::msg::Header>::value> {};

template<>
struct is_message<dro_hg::msg::LegCmd>
  : std::true_type {};

}  // namespace rosidl_generator_traits

#endif  // DRO_HG__MSG__DETAIL__LEG_CMD__TRAITS_HPP_
