...
class ArmCmd(metaclass=Metaclass_ArmCmd):
    ...
    _fields_and_field_types = {
        ...
        'begin': 'uint8',
        'end': 'uint8',
        'motor_cmd': 'sequence<dro_hg/MotorCmd, 14>',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.BasicType('uint8'),  # noqa: E501
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['dro_hg', 'msg'], 'MotorCmd'), 14),  # noqa: E501
    )
