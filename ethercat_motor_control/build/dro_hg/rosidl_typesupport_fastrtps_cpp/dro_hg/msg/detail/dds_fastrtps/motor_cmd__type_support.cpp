...
#include "dro_hg/msg/detail/motor_cmd__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const dro_hg::msg::MotorCmd & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  dro_hg::msg::MotorCmd & ros_message)
{
  // Member: mode
  cdr >> ros_message.mode;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = dro_hg::msg::MotorCmd;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const dro_hg::msg::MotorCmd *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<dro_hg::msg::MotorCmd *>(
    untyped_ros_message);
...
{
  return &dro_hg::msg::typesupport_fastrtps_cpp::_MotorCmd__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, dro_hg, msg, MotorCmd)() {
  return &dro_hg::msg::typesupport_fastrtps_cpp::_MotorCmd__handle;
}
