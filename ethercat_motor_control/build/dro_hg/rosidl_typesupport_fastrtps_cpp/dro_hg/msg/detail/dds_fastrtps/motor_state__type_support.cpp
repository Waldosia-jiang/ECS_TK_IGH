...
#include "dro_hg/msg/detail/motor_state__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = dro_hg::msg::MotorState;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const dro_hg::msg::MotorState *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<dro_hg::msg::MotorState *>(
    untyped_ros_message);
...
{
  return &dro_hg::msg::typesupport_fastrtps_cpp::_MotorState__handle;
}
