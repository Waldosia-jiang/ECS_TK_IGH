...
#include "dro_hg/msg/detail/arm_cmd__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const dro_hg::msg::ArmCmd & ros_message,
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = dro_hg::msg::ArmCmd;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const dro_hg::msg::ArmCmd *>(
    untyped_ros_message);
...
{
  return &dro_hg::msg::typesupport_fastrtps_cpp::_ArmCmd__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, dro_hg, msg, ArmCmd)() {
  return &dro_hg::msg::typesupport_fastrtps_cpp::_ArmCmd__handle;
}
