...
class LegState(metaclass=Metaclass_LegState):
    ...
    _fields_and_field_types = {
        ...
        'slave_num': 'uint8',
        'motor_state': 'sequence<dro_hg/MotorState, 15>',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.NamespacedType(['std_msgs', 'msg'], 'Header'),  # noqa: E501
        rosidl_parser.definition.BasicType('uint8'),  # noqa: E501
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['dro_hg', 'msg'], 'MotorState'), 15),  # noqa: E501
    )
        ...
        if __debug__:
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 True), \
                "The 'motor_state' field must be a set or sequence with length <= 15 and each value of type 'MotorState'"
