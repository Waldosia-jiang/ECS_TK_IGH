...
bool dro_hg__msg__arm_state__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("dro_hg.msg._arm_state.ArmState", full_classname_dest, 30) == 0);
  }
  dro_hg__msg__ArmState * ros_message = _ros_message;
  {  // header
...
PyObject * dro_hg__msg__arm_state__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("dro_hg.msg._arm_state");
