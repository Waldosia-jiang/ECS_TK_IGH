...
#ifndef DRO_HG__MSG__DETAIL__MOTOR_CMD__TRAITS_HPP_
#define DRO_HG__MSG__DETAIL__MOTOR_CMD__TRAITS_HPP_
...
inline std::string to_yaml(const dro_hg::msg::MotorCmd & msg)
{
  return dro_hg::msg::to_yaml(msg);
}

template<>
inline const char * data_type<dro_hg::msg::MotorCmd>()
{
  return "dro_hg::msg::MotorCmd";
}

template<>
inline const char * name<dro_hg::msg::MotorCmd>()
{
  return "dro_hg/msg/MotorCmd";
}

template<>
struct has_fixed_size<dro_hg::msg::MotorCmd>
  : std::integral_constant<bool, true> {};

template<>
struct has_bounded_size<dro_hg::msg::MotorCmd>
  : std::integral_constant<bool, true> {};

template<>
struct is_message<dro_hg::msg::MotorCmd>
  : std::true_type {};

}  // namespace rosidl_generator_traits

#endif  // DRO_HG__MSG__DETAIL__MOTOR_CMD__TRAITS_HPP_
