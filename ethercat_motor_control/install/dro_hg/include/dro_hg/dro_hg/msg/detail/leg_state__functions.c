...
dro_hg__msg__LegState__init(dro_hg__msg__LegState * msg)
{
  ...
  if (!std_msgs__msg__Header__init(&msg->header)) {
    dro_hg__msg__LegState__fini(msg);
    return false;
  }
  // slave_num
  // motor_state
...
dro_hg__msg__LegState__create()
{
  ...
  dro_hg__msg__LegState * msg = (dro_hg__msg__LegState *)allocator.allocate(sizeof(dro_hg__msg__LegState), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(dro_hg__msg__LegState));
  bool success = dro_hg__msg__LegState__init(msg);
  if (!success) {
...
dro_hg__msg__LegState__Sequence__init(dro_hg__msg__LegState__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  dro_hg__msg__LegState * data = NULL;

  if (size) {
    data = (dro_hg__msg__LegState *)allocator.zero_allocate(size, sizeof(dro_hg__msg__LegState), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = dro_hg__msg__LegState__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        dro_hg__msg__LegState__fini(&data[i - 1]);
      }
...
dro_hg__msg__LegState__Sequence__fini(dro_hg__msg__LegState__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      dro_hg__msg__LegState__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  dro_hg__msg__LegState__Sequence * array = (dro_hg__msg__LegState__Sequence *)allocator.allocate(sizeof(dro_hg__msg__LegState__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = dro_hg__msg__LegState__Sequence__init(array, size);
  if (!success) {
...
dro_hg__msg__LegState__Sequence__destroy(dro_hg__msg__LegState__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    dro_hg__msg__LegState__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
dro_hg__msg__LegState__Sequence__are_equal(const dro_hg__msg__LegState__Sequence * lhs, const dro_hg__msg__LegState__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!dro_hg__msg__LegState__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  dro_hg__msg__LegState__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(dro_hg__msg__LegState);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    dro_hg__msg__LegState * data =
      (dro_hg__msg__LegState *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!dro_hg__msg__LegState__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          dro_hg__msg__LegState__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!dro_hg__msg__LegState__copy(
